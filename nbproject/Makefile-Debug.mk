...
${OBJECTDIR}/ConnectFour.o: ConnectFour.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ConnectFour.o ConnectFour.cpp

${OBJECTDIR}/GameFuncs.o: GameFuncs.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GameFuncs.o GameFuncs.cpp

${OBJECTDIR}/Tetris.o: Tetris.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Tetris.o Tetris.cpp
